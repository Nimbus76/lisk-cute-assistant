...
exports.localNodeURL = "http://127.0.0.1:8000/api/node/status"; // If you want to use for testing "https://node04.lisk.io/api/loader/status/sync" or use your node in testnet, don't forget the port 7000
